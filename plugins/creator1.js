...
let teksbio2 = `┆⫹⫺ 💌 Nama : Asya
┆⫹⫺ ♂️ Gender : Wanita
┆⫹⫺ 🕋 Agama : Islam
┆⫹⫺ ⏰ Tanggal lahir : 21 - 05- 2007
┆⫹⫺ 🎨 Umur : 16
┆⫹⫺ 🧮 Kelas : X
┆⫹⫺ 🧩 Hobby : Banyak
┆⫹⫺ 💬 Sifat : ASIK,BAIK,RAMAH
...
𐚀 Owner Berhak Blok Siapa Saja
𐚀 Etikanya Di Pake
...
{title: "⸙ Biodata Renzy", rowId: ".owner bio"},
{title: "⸙ Biodata Aca", rowId: ".owner bio2"},
...
await conn.sendMessage(m.chat, { contacts: { displayName: wm, contacts: [{ vcard }] }}, { quoted: ftroli })
 ...
 conn.send2ButtonImg(m.chat, fs.readFileSync('./media/menu.jpg').buffer, teksnomor, `Halo ${tag}\nIᴛᴜ Oᴡɴᴇʀ Kᴜ⫺⫰⫹\n` + botdate, `Sewa Bot`, `.sewa`, 'Menu', `.menu`, ftroli, { contextInfo: { externalAdReply: { showAdAttribution: true,
    mediaUrl: 'https://instagram.com/renzy.amstrg',
    mediaType: 2, 
    description: sgc,
   ...
   conn.sendButton(m.chat, '┍┈༺ *BioData RenzyHax* ༻', teksbio, ppown, [
          ...
          conn.sendButton(m.chat, '┍┈༺ *BioData Aca* ༻', teksbio2, ppown2, [
                ['Sewa', `${usedPrefix}sewa`],
                ['Menu', `${usedPrefix}menu`]
            ], m)
            break
