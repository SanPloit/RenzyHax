...
global.sgh = 'https://github.com/SanPloit' // github
global.sgc = 'https://chat.whatsapp.com/IwA6LMPts0xIWNOkgLQUHt' // group whatsapp
global.sdc = 'https://www.discord.com'//discord
global.snh = '-' // my youtube channel
global.sfb = 'https://www.facebook.com/' // facebook
global.syt = 'https://www.youtube.com/@DemonRenzy'
global.tik = 'https://www.tiktok.com/@renzy.amstrg_' 
global.tautanwa = 'https://wa.me/6285717118807'
global.wame = 'https://wa.me/6285717118807' // kalau gk punya bisa ganti pake gini wa.me/6285717118807

/*============== PAYMENT ==============*/
global.pdana = '0857 1711 8807' //dana
global.povo = '0857 1711 8807' //ovo
global.pgopay = '0857 1711 8807' //gopay
global.plinkaja = '0857 1711 8807' //link aja
global.ppulsa = '0857 1711 8807' //telkomsel
global.ppulsa2 = '-' // kalau ada kartu lain isi aja
global.psaweria = '-'

/*============== NOMOR ==============*/
global.nomorbot = '6281296496599'
global.nomorown = '6285717118807'
global.nomorown1 = '6289629605986' //pake No Pacar lo Juga Boleh
global.namebot = 'Renzy BOT'
global.nameown = 'Renzy Hax'
global.nameown1 = 'Asya Rizkia' //Pake Nama Pacar Lo Juga Boleh

//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ INFO BIO DATA OWN ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
global.sig = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/renzy.amstrg' // ig lo
global.sigpcr = '📷 ɪɴsᴛᴀɢʀᴀᴍ : https://instagram.com/asyarzkiia' // ig cewek lo
/*============== Github Thanks To ==============*/
global.namagithub = 'SanPloit' // nama github lu
global.linkgithub = 'https://github.com/SanPloit' // tarok link github lu

// klau kgk ada github kasih tanda '-' aja biar kgk error

/*============== STAFF ==============*/
global.owner = [
  ['6285717118807', 'Renzy Hax', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
...
/*============== WATERMARK ==============*/
global.gcname = 'Renzy Learn!'//nama group kalian
global.readMore = readMore
global.wm = '                「 Renzy Hax 」'
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘Renzy Hax ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Renzy Hax '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Renzy Hax`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '              「 Renzy Hax  あ」'
global.week = `${week} ${date}`
global.wibb = `${wktuwib}`
global.danied = pickRandom(["✘ 𝗘𝗿𝗼𝗿 𝟰𝟬𝟰","𝘼𝙠𝙨𝙚𝙨 𝘿𝙞𝙩𝙤𝙡𝙖𝙠","⚠️ 𝘼𝙘𝙘𝙨𝙚𝙨 𝘿𝙖𝙣𝙞𝙚𝙙 ⚠️"])

/*============== STICKER WM ==============*/
global.stickpack = 'RENZYBOT Hax'
global.stickauth = `By ©RENZY HAX`
...
global.urlnya = "https://www.instagram.com/renzy.amstrg"
global.dtc = 'ᴄᴀʟʟ ᴏᴡɴᴇʀ'
global.phn = '0857-1711-8807'
//⫹⫺ ╳╶╼╶╶╶╶┈ ⎝ JNGN DI UBAH ⎞ ┈╴╴╴╴╾╴╳ ⫹⫺
